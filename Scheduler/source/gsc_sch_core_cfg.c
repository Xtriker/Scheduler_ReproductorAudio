...
const S_SCH_MANAGER_EXEC_TYPE cps_mngTaskList[SCHD_MANAGERS_NUMBER] = 
{
   /* Main function,               Init Function,                    Startup delay(ticks),  Execution Period(ticks),   Operation mode */
    ...
    {periodic_tasks_exec_5tks,     NULL,   							 5,                     5,                         ALL_MODES},
    {periodic_tasks_exec_10tks,    NULL,   							10,                  	10,                        ALL_MODES},
    {periodic_tasks_exec_20tks,    NULL,   							20,                     20,                        ALL_MODES},
    {periodic_tasks_exec_50tks,    NULL,   							50,                     50,                        ALL_MODES},
    {periodic_tasks_exec_100tks,   periodic_tasks_init_task_100tks,100,                    100,                        ALL_MODES},
    {periodic_tasks_exec_500tks,   NULL,  						   500,                    500,                        ALL_MODES},
